<?php $category=$_SESSION['userLogin']['category']?>
<?php $motion_type=1==$category?'建议/议案':'提案'?>
...
<header class="header">
    <div class="header-l"><img src="images/p<?php echo $category?>.jpg" alt="logo"></div>
    <div class="header-r">
        <a href="#">密码修改</a>
...
<nav class="home-nav">
    <ul class="clearfix">
        ...
        <?php if(2==$category):?><li class="li7"><a href="#">百件提案汇编</a></li><?php endif ?>
...
<section class="clearfix" id="section">
    <aside id="aside">
        <ul>
            ...
            <?php if(2==$category):?><li class="motion-filter" data-filter="preCoop" >征集附议<?php echo $motion_type?></li><?php endif?>
...
<!--            <li class="motion-filter">--><?php //echo $motion_type?><!--查询</li>-->
    ...
    <div class="left section-main" id="main">
        <div class="main-navbar"><h2>当前位置:<em><span  class="current-position">本届</span><?php echo $motion_type?></em></h2></div>
...
<div class="popup popup1" style="display: none;">
    ...
    <div class="motion">
        ...
        <div class="popup-table">
            <h2 class="p-tab-title"><?php echo 1 == $category ? '慈溪市人大建议议案办理单' : '慈溪市政协提案办理单' ?></h2>
            ...
            <table width="" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td><?php echo 1 == $category ? '领衔人' : '提案人' ?></td>
                        <td class="user-name">
                    ...
                    <tr>
                        ...
                        <td>性质</td>
                        <td><input type="radio" name="property" value="当年" checked>当年&nbsp;<input type="radio" name="property" value="多年重复" <?php if(1==$category) echo 'disabled="disabled"' ?>>多年重复</td>
                    </tr>
                    ...
                    <?php if(1==$category):?>
                        <tr>
                            ...
                            <td>附议人</td>
                            <td>
                                <button class="target-select" data-target="duty" type="button" data-multiple="1" data-dutytype="coop">选择</button>
                            </td>
                            <?php endif ?>
                            <td>案别</td>
                            <td class="user-group" <?php if(!isset($_SESSION['userLogin']['is_admin']))echo 'colspan="3"'?>><select name="motion_type"><option value="建议">建议</option><option value="议案">议案</option></select></td>
                            </tr>
                    <?php endif ?>
                    <tr>
    ...
    <div class="motion my-messege">
        ...
        <div class="popup-table">
            <table width="" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>姓名</td>
                    <td><?= $_SESSION['userLogin']['user_name']?></td>
                    <td>身份证号</td>
                    <td></td>
                </tr>
                <tr>
    ...
    <div class="motion radius">
        <div class="unit">
            ...
            <div class="unit-table">
                ...
                <input type="hidden" class="duty-type">
